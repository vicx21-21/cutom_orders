...
public class ProductsTypesController implements Initializable {
    ...
    @FXML private TableView<ProductType> productTypeTable;
    @FXML private TableColumn<ProductType, String> codeColumn;
    @FXML private TableColumn<ProductType, String> nameColumn;
    @FXML private TableColumn<ProductType, String> parentCodeColumn;

    // Componentes FXML del formulario
    @FXML private TextField codeField;
    @FXML private TextField nameField;
    @FXML private ComboBox<ProductType> parentTypeComboBox;
        ...
        if (type != null) {
            ...
            if (parentCode.isEmpty()) {
                ...
                parentTypeComboBox.getItems().stream()
                        .filter(pt -> pt.getProductTypeCode().equals(parentCode))
                        .findFirst()
    ...
    private void handleSave() {
        ...
        ProductType selectedParent = parentTypeComboBox.getSelectionModel().getSelectedItem();
